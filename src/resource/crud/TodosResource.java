...
public class TodosResource {
    ...
    // Use http://localhost:8080/jersey-restful-sample/api/crud/todos/count
    ...
    // Allows to type http://localhost:8080/jersey-restful-sample/api/crud/todos/1
